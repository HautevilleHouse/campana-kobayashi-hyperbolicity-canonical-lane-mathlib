/-!
# Source package model for `campana-kobayashi-hyperbolicity-canonical-lane`
...
def sourceCheckoutHead : String := "b324a7cd62e797c62a29bb689b9a357a37f7cf93"
def sourceCheckoutClean : Bool := true

def sourceFiles : List SourceFile := [
  { path := "scripts/ckh_closure_guard.py", sha256 := "62a0ca01f21c7483d69eee4e6716c5fc8fb77232557dadfa2f72aeff6d1f9c7c", functionCount := 9, classCount := 0, assignmentCount := 8, parseOk := true },
...
def sourceFunctions : List SourceFunctionDecl := [
  { file := "scripts/ckh_closure_guard.py", name := "_finite", args := ["v"], returns := "bool", doc := "", line := 31, isAsync := false },
  { file := "scripts/ckh_closure_guard.py", name := "_resolve", args := ["path_str"], returns := "Path", doc := "", line := 35, isAsync := false },
  { file := "scripts/ckh_closure_guard.py", name := "_bootstrap_registry", args := ["path"], returns := "None", doc := "", line := 40, isAsync := false },
  { file := "scripts/ckh_closure_guard.py", name := "_load_registry", args := ["path"], returns := "dict[str, Any]", doc := "", line := 46, isAsync := false },
  { file := "scripts/ckh_closure_guard.py", name := "_load_sigma_from_stitch", args := ["path"], returns := "float | None", doc := "", line := 58, isAsync := false },
  { file := "scripts/ckh_closure_guard.py", name := "_entry", args := ["constants", "key"], returns := "tuple[float | None, bool]", doc := "", line := 75, isAsync := false },
  { file := "scripts/ckh_closure_guard.py", name := "compute_report", args := ["data", "sigma_star", "strict_coh_zero"], returns := "dict[str, Any]", doc := "", line := 86, isAsync := false },
  { file := "scripts/ckh_closure_guard.py", name := "append_history", args := ["path", "report"], returns := "None", doc := "", line := 119, isAsync := false },
  { file := "scripts/ckh_closure_guard.py", name := "main", args := [], returns := "None", doc := "", line := 126, isAsync := false },
...
def sourceAssignments : List SourceAssignmentDecl := [
  { file := "scripts/ckh_closure_guard.py", name := "SCRIPT_DIR", value := "Path(__file__).resolve().parent", line := 13 },
  { file := "scripts/ckh_closure_guard.py", name := "PROJECT_ROOT", value := "SCRIPT_DIR.parent", line := 14 },
  { file := "scripts/ckh_closure_guard.py", name := "DEFAULT_REGISTRY", value := "\"artifacts/constants_registry.json\"", line := 16 },
  { file := "scripts/ckh_closure_guard.py", name := "DEFAULT_STITCH", value := "\"artifacts/stitch_constants.json\"", line := 17 },
  { file := "scripts/ckh_closure_guard.py", name := "DEFAULT_OUT", value := "\"repro/certificate_runtime.json\"", line := 18 },
  { file := "scripts/ckh_closure_guard.py", name := "DEFAULT_HISTORY", value := "\"repro/drift_guard_runs.jsonl\"", line := 19 },
  { file := "scripts/ckh_closure_guard.py", name := "PRIMARY_KEYS", value := "[\"kappa_hyperbolic\", \"sigma_entire\", \"kappa_compact\", \"rho_rigidity\", \"orbifold_lock\"]", line := 21 },
  { file := "scripts/ckh_closure_guard.py", name := "COHERENCE_KEY", value := "\"eps_coh\"", line := 28 },
...
def constantSpecs : List ConstantSpec := [
  { group := "constants", key := "kappa_hyperbolic", status := "derived_numeric", formula := "c_core_raw * density_raw - e_core_raw", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md Section 3", validation := "required_positive", componentKeys := ["c_core_raw", "density_raw", "e_core_raw"] },
  { group := "constants", key := "sigma_entire", status := "derived_numeric", formula := "capture_floor_raw - transport_loss_raw - restart_loss_raw", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md Section 3", validation := "required_positive", componentKeys := ["capture_floor_raw", "restart_loss_raw", "transport_loss_raw"] },
  { group := "constants", key := "kappa_compact", status := "derived_numeric", formula := "1.0 / (1.0 + delta_comp_sup_raw)", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md Section 3", validation := "required_positive", componentKeys := ["delta_comp_sup_raw"] },
  { group := "constants", key := "rho_rigidity", status := "derived_numeric", formula := "rho_rigidity_raw", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md Section 3", validation := "required_positive", componentKeys := ["rho_rigidity_raw"] },
  { group := "constants", key := "orbifold_lock", status := "derived_numeric", formula := "c_transfer_raw * transfer_gain_raw - e_transfer_raw", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md Section 3", validation := "required_positive", componentKeys := ["c_transfer_raw", "e_transfer_raw", "transfer_gain_raw"] },
  { group := "constants", key := "eps_coh", status := "derived_numeric", formula := "eps_coh_raw", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md Section 3", validation := "required_nonnegative", componentKeys := ["eps_coh_raw"] },
  { group := "stitch", key := "sigma_star_can", status := "derived_numeric", formula := "sigma_star_can_raw", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md stitch constants", validation := "required_positive", componentKeys := ["sigma_star_can_raw"] }
]

def registryConstants : List RegistryConstant := [
  { key := "eps_coh", value := "0.0", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#eps_coh", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md Section 3" },
  { key := "kappa_compact", value := "0.8038585209003215", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_compact", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md Section 3" },
  { key := "kappa_hyperbolic", value := "1.091838", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_hyperbolic", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md Section 3" },
  { key := "orbifold_lock", value := "1.02951", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#orbifold_lock", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md Section 3" },
  { key := "rho_rigidity", value := "1.077", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#rho_rigidity", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md Section 3" },
  { key := "sigma_entire", value := "1.075", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#sigma_entire", sourceSection := "paper/CAMPANA_KOBAYASHI_HYPERBOLICITY_PREPRINT.md Section 3" }
]
