# Campana Kobayashi Hyperbolicity — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/campana-kobayashi-hyperbolicity-canonical-lane-mathlib.git
cd campana-kobayashi-hyperbolicity-canonical-lane-mathlib
lake exe
lake build
```
